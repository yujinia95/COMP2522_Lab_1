...
public class Main
{
    ...
    public static void main(final String[] args)
    {
        ...
        albertBankAccount = new BankAccount(albertBankClient, albertAccountBalance, albertPin, albertAccountNumb, sexM, albertCloseDate, albertWithdrawAmount);
        ...
        nelsonBankAccount = new BankAccount(nelsonBankClient, nelsonAccountBalance, nelsonPin, nelsonAccountNumb, sexM, null, nelsonWithdrawAmount);
        ...
        kahloBankAccount =  new BankAccount(kahloBankClient, kahloAccountBalance, kahloPin, kahloAccountNumb, sexF, kahloCloseDate, kahloWithdrawAmount);
        ...
        jackieBankAccount = new BankAccount(jackieBankClient, jackieAccountBalance, jackiePin, jackieAccountNumb, sexM, null, jackieWithdrawAmount);
